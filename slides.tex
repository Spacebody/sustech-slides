...
\usepackage{amsmath,amssymb,enumerate,epsfig,bbm,calc,color,ifthen,capt-of,multimedia,hyperref,graphicx,tikz, amsfonts, bm}
\usefonttheme[onlymath]{serif} %change the font in math mode
%\usepackage[labelformat=empty]{caption} %remove caption 
\newcommand{\source}[1]{\caption*{Source: {#1}} } %add source of images
...
%\logo{\includegraphics[height=1.0cm]{sustech-logo2.png}} %change logo
...
\section[Outline]{}
\begin{frame}{Outline}
%\begin{frame}[allowframebreaks]{Outline} %allow outline to split
  \tableofcontents
\end{frame}
